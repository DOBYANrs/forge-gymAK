...
const FRONT_MUSCLES: Record<string, MuscleGroupDef> = {
  ...
  'Abductors': {
    // Outer thigh — from hip/glute down the outside of the leg
    path: `M32,118 C30,118 28,122 28,128 L28,158 C28,164 30,168 32,168
           L40,168 C42,168 42,164 42,158 L42,128 C42,122 40,118 38,118 Z
           M84,118 C86,118 88,122 88,128 L88,158 C88,164 86,168 84,168
           L76,168 C74,168 74,164 74,158 L74,128 C74,122 76,118 78,118 Z`,
    label: 'Abductors', cx: 34, cy: 144,
  },
  'Adductors': {
    // Inner thigh — between the legs
    path: `M40,124 C42,124 44,128 44,134 L44,164 C44,168 42,170 40,170
           L48,170 C50,170 50,168 50,164 L50,134 C50,128 48,124 46,124 Z
           M76,124 C74,124 72,128 72,134 L72,164 C72,168 74,170 76,170
           L68,170 C66,170 66,168 66,164 L66,134 C66,128 68,124 70,124 Z`,
    label: 'Adductors', cx: 44, cy: 148,
  },
  'Calves': {
