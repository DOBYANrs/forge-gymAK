...
export const WEEKLY_SCHEDULE: DaySchedule[] = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: 'Standing Calf Raise', pattern: 'normal', defaultSets: 6, targetReps: '10–15', restSeconds: 60 },
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: 'Adduction Machine', pattern: 'normal', defaultSets: 3, targetReps: '15–20', restSeconds: 60 },
      { name: 'Standing Calf Raise', pattern: 'normal', defaultSets: 6, targetReps: '15–20', restSeconds: 60, notes: 'Pause at peak contraction' },
